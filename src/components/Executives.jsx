...
export default function Executives(props) {
    ...
    return (
        <div className="purple-gradient" style={{paddingTop: "30px"}}>
        ...
        <ContentTitle top={"Discover Game Technologies"} bottom={"at the University of Gloucestershire"} color="white"/>
            ...
            <div className="padding-block-end executive-column content-padding col-2-fr-1 white">
                <div>
                ...
                <div>
                    ...
                    <button className="bg-white button"> View Gallery </button>
                </div>
            </div>
            </section>
        </div>
